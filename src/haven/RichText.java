...
public class RichText extends Text {
	 ...
	 * TextAttribute.SIZE had to be specified with a Float, and not a general
	 * Number; however, Java 1.6 fails to mention that in the documentation
	 * (which rather explicitly says that any java.lang.Number is perfectly OK
	 * and accepted practice). However, specifying ints for font size looks
	 * nicer in the rest of the code, so this function gets to collect all the
	 * ugliness of conversion in itself.
	 */
