...
public class ChatUI extends Widget {
	...
	public static class FuckMeGentlyWithAChainsaw {
		/*
		 * This wrapper class exists to work around the possibly most stupid
		 * Java bug ever (and that's saying a lot): That URL.equals and
		 * URL.hashCode do DNS lookups and block. Which, of course, not only
		 * sucks performance-wise but also breaks actual correct URL equality.
		 */
