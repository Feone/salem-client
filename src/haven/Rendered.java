...
public interface Rendered extends Drawn {
	...
	public final static Order eyesort = new Order.Default(10000) {
		private final RComparator<Rendered> cmp = new RComparator<Rendered>() {
			public int compare(Rendered a, Rendered b, GLState.Buffer sa, GLState.Buffer sb) {
				/*
				 * It would be nice to be able to cache these results somewhere.
				 */
	...
	public static class ScreenQuad implements Rendered {
		...
		private static final VertexBuf.VertexArray pos = new VertexBuf.VertexArray(Utils.bufcp(new float[] { -1, -1, 0, 1, -1, 0, 1, 1, 0, -1, 1, 0, }));
		private static final VertexBuf.TexelArray tex = new VertexBuf.TexelArray(Utils.bufcp(new float[] { 0, 0, 1, 0, 1, 1, 0, 1, }));
