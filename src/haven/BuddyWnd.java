...
public class BuddyWnd extends Window implements Iterable<BuddyWnd.Buddy> {
	...
	public static final Color[] gc = new Color[] { new Color(255, 255, 255), new Color(0, 255, 0), new Color(255, 0, 0), new Color(0, 0, 255), new Color(0, 255, 255), new Color(255, 255, 0), new Color(255, 0, 255), new Color(255, 0, 128), };
	...
	public BuddyWnd(Coord c, Widget parent) {
		...
		sbstatus = new Button(new Coord(50, 220), 48, this, "Status") {
			public void click() {
				setcmp(statuscmp);
			}
		};
		sbgroup = new Button(new Coord(100, 220), 48, this, "Group") {
			public void click() {
				setcmp(groupcmp);
			}
		};
		sbalpha = new Button(new Coord(150, 220), 48, this, "Name") {
			public void click() {
				setcmp(alphacmp);
			}
		};
