...
public class Struct extends Type {
	...
	public static final Struct gl_LightSourceParameters = make(new Symbol.Fix("gl_LightSourceParameters"), Type.VEC4, "ambient", Type.VEC4, "diffuse", Type.VEC4, "specular", Type.VEC4, "position", Type.VEC4, "halfVector", Type.VEC3, "spotDirection", Type.FLOAT, "spotExponent", Type.FLOAT, "spotCutoff", Type.FLOAT, "spotCosCutoff", Type.FLOAT, "constantAttenuation", Type.FLOAT,
			"linearAttenuation", Type.FLOAT, "quadraticAttenuation");
