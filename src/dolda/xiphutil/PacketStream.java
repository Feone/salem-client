...
/**
 * The <code>Packet</code> class decodes Ogg packets from a page stream.
 * 
...
public class PacketStream {
	 ...
	 * 
	 * @param in
	 *            the {@link PageStream} object to decode packets from.
	 */
	 ...
	 * 
	 * @return the packet fetched, or <code>null</code> if at the end of the
	 *         stream.
	 * @exception java.io.IOException
	 *                if the <code>PageStream</code> itself throws an
